              ...
              .map(
                (participant) => `
                  <li>
                    ...
                    <button type="button" class="delete-participant" data-activity="${name}" data-participant="${participant}" aria-label="Unregister ${participant} from ${name}" title="Unregister participant">&#128465;</button>
                  </li>`
              )
              .join("")}</ul>`
